            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="passanger-name">
                        <div class="media">
                            <img class="me-3" src="<?php echo $assets['img'];?>partner-img.png" alt="partner-img">
                            <div class="media-body">
                                <h2 class="mt-0">Janitha sadun</h2>
                                <p>ID 1234567890</p>
                                ...
                                <div class="dashboard-info">
                                    ...
                                    <div class="overview-counter small-div">
                                        ...
                                        <div class="counter-wrapper bg-gray small-div-item">
                                            ...
                                            <div class="single-counter-box">
                                                <h2 class="counter-number" style="color: #F7BC00;">21785</h2>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control text-muted" id="inputStatus" readonly value="Married">
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
